...
use crate::server::common::upload::{resolve_source, studio_from_template};
...
impl Archive {
    ...
    pub fn render(&self) -> Rendered {
        ...
        Rendered {
            ...
            desc: truncate(&render(&desc_tpl, &self.info, &first), MAX_DESC_CHARS),
            tags,
            tid: effective.tid,
